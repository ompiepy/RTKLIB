    ...
    : QDialog(parent), options(opts), ui(new Ui::OptDialog)
{
    ...
    ui->cBAmbiguityResolutionBDS->setItemData(0, tr("Disable ambiguity resolution"), Qt::ToolTipRole);
    ui->cBAmbiguityResolutionBDS->setItemData(1, tr("Enable ambiguity resolution"), Qt::ToolTipRole);
